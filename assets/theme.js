      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (!newVariant) {
          ...
          if (newVariant['compare_at_price'] > newVariant['price']) {
            $('.ProductMeta__PriceList .Price--highlight').html(Currency.formatMoney(newVariant['price'], currencyFormat));
            $('.ProductMeta__PriceList .Price--compareAt').html(Currency.formatMoney(newVariant['compare_at_price'], currencyFormat));
