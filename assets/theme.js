...
(function (factory) {
    ...
    _createClass(Modal, [
      ...
      },
      {
        ...
        value: function _resetVideo(event) {
          ...
          iframe.parentNode.innerHTML = '<iframe class="Image--lazyLoad" data-src='.concat(
  ...
  var Popover = /*#__PURE__*/ (function () {
    function Popover(element, options) {
      ...
      this.activator =
        options["activator"] ||
        document.querySelector('[aria-controls="'.concat(element.getAttribute("id"), '"]'));
      ...
      },
      {
        ...
        value: function _onFocusOut(event) {
          if (
            ...
            event.relatedTarget !== this.activator
          ) {
            this.close();
          }
        },
        ...
        value: function _position() {
          ...
          fastdom.measure(function () {
            ...
            if (_this2.preferredPosition === "bottom") {
              ...
              if (
                _this2.element.clientHeight <= activatorBoundingRect.top - threshold ||
          ...
          fastdom.mutate(function () {
            ...
            _this2.element.classList.add(
              "Popover--position".concat(position.charAt(0).toUpperCase() + position.slice(1)),
            );

            _this2.element.classList.add(
              "Popover--align".concat(alignment.charAt(0).toUpperCase() + alignment.slice(1)),
            );
      ...
      },
      {
        ...
        value: function _createPhotoSwipeInstance(items, selectedImageIndex) {
          ...
          this.photoSwipeInstance = new PhotoSwipe(photoswipeContainer, false, items, {
            ...
            pinchToClose: false,
            errorMsg:
              '<p class="pswp__error-msg">' + window.languages.productImageLoadingError + "</p>",
            scaleMode: "zoom",
      ...
      },
      {
        ...
        value: function _onVariantChanged(event) {
          ...
          Dom.nodeListToArray(imageWrapperElements).forEach(function (image) {
            var colorPosition =
                parseInt(image.parentElement.getAttribute("data-option-position")) - 1,
          ...
          Dom.nodeListToArray(
            ...
            _this.parentProductVariants.productData["variants"].forEach(function (variant) {
              ...
              if (
                ...
                variant["options"][colorPosition] === selectedVariant["options"][colorPosition]
              ) {
                if (foundColorIndex++ === index) {
                  priceElement.innerHTML = '<span class="Heading Text--subdued">'.concat(
                    Currency.formatMoney(variant["price"], window.theme.moneyFormat),
                    "</span>",
                  );
                }
              }
        ...
        value: function _renderAvailabilitySection(id) {
          ...
          return fetch(
            ...
            return response.text().then(function (content) {
              ...
              _this.existingDrawers["StoreAvailabilityModal-".concat(id)] = new Drawer(
                availabilityModal,
              );
            });
          });
    ...
    _createClass(ProductVariants, [
      ...
      },
      {
        ...
        value: function _createSelectors() {
          ...
          Dom.nodeListToArray(this.element.querySelectorAll(".OptionSelector")).forEach(
            function (item) {
          ...
          Dom.nodeListToArray(this.element.querySelectorAll(".VariantSelector")).forEach(
            function (item) {
        ...
        value: function _updateProductPrices(newVariant, previousVariant) {
          ...
          if (!newVariant) {
            ...
            if (newVariant["compare_at_price"] > newVariant["price"]) {
              $(".ProductMeta__PriceList .Price--highlight").html(
                Currency.formatMoney(newVariant["price"], currencyFormat),
              );
              $(".ProductMeta__PriceList .Price--compareAt").html(
                Currency.formatMoney(newVariant["compare_at_price"], currencyFormat),
              );
      ...
      },
      {
        ...
        value: function _updateUnitPrice(newVariant) {
          ...
          unitPriceMeasurement.querySelector(".UnitPriceMeasurement__Price").innerHTML =
            Currency.formatMoney(newVariant["unit_price"], window.theme.moneyFormat);
          unitPriceMeasurement.querySelector(".UnitPriceMeasurement__ReferenceUnit").textContent =
            ...
            if (!newVariant) {
              ...
              if (newVariant["available"]) {
                ...
                addToCartButton.classList.add(
                  addToCartButton.getAttribute("data-use-primary-button") === "true"
                    ? "Button--primary"
                    : "Button--secondary",
                );
            ...
            fetch(
              ""
                ...
                .concat(
                  ...
                  "&options[prefix]=last&type=product",
                ),
              queryOptions,
            ),
          ];
          ...
          fetch(
            ...
            response.json().then(function (result) {
              ...
              if (response.ok) {
                ...
                if (shippingRates.length === 0) {
                  ...
                  shippingRates.forEach(function (item) {
                    html += "<li>"
                      .concat(item["name"], ": ")
                      .concat(
                        Currency.formatMoney(item["price"], window.theme.moneyFormat),
                        "</li>",
                      );
                  });
                  html += "</ul>";
                ...
                errorContainer.innerHTML = '<ul class="Alert__ErrorList">'.concat(
                  errorHtml,
                  "</ul>",
                );
      ...
      },
      {
        ...
        value: function _changeLayoutMode(event, target) {
          ...
          if (productList) {
            ...
            Dom.nodeListToArray(productList.querySelectorAll(".Grid__Cell")).forEach(
              function (item) {
      ...
      },
      {
        ...
        value: function _onFilterChanged(event) {
          ...
          this._reloadProducts(
            "".concat(window.location.pathname, "?").concat(searchParamsAsString),
          );
        },
      },
      {
          ...
          try {
            ...
            fetch(currentUrl.toString(), {
              ...
              response.text().then(function (content) {
                ...
                _this4.collectionInnerElement.innerHTML = tempElement.querySelector(
                ...
                if (collectionFiltersDrawer) {
                  ...
                  Array.from(collectionFiltersDrawer.querySelectorAll(".Collapsible")).forEach(
                    function (collapsible) {
                ...
                if (collectionFiltersSidebar) {
                  ...
                  Array.from(collectionFiltersSidebar.querySelectorAll(".Collapsible")).forEach(
                    function (collapsible) {
                ...
                var elementOffset =
                  _this4.element.querySelector(".CollectionMain").getBoundingClientRect().top -
  ...
  var FeaturedCollectionsSection = /*#__PURE__*/ (function () {
    function FeaturedCollectionsSection(container) {
      ...
      this.carousels = [];
      Dom.nodeListToArray(this.element.querySelectorAll("[data-flickity-config]")).forEach(
        function (item) {
      ...
      },
      {
        ...
        value: function _switchTab(event, target) {
          ...
          this.timeline.eventCallback("onReverseComplete", function () {
            ...
            Dom.getSiblings(tabPanelToShow, '.TabPanel[aria-hidden="false"]').forEach(
              function (item) {
      ...
      },
      {
        ...
        value: function _updateMainImage(event) {
          ...
          newImageElement.setAttribute(
            "data-src",
            Image.getSizedImageUrl(newImage["src"], "1x1").replace("_1x1.", "_{width}x."),
          );
          newImageElement.setAttribute(
            "data-widths",
            "[".concat(
              Image.getSupportedSizes(newImage, [200, 400, 600, 700, 800, 900, 1000]).join(","),
              "]",
            ),
          );
    ...
    _createClass(HeaderSection, [
      ...
      },
      {
        ...
        value: function _setupLocalizationPopovers() {
          ...
          Dom.nodeListToArray(document.querySelectorAll("#header-locale-popover")).forEach(
            function (item, index) {
          ...
          Dom.nodeListToArray(document.querySelectorAll("#header-currency-popover")).forEach(
            function (item, index) {
              item.id = "".concat(item.id, "-").concat(index);
            },
          );
      ...
      },
      {
        ...
        value: function _closeNavigation() {
          ...
          fastdom.mutate(function () {
            Dom.nodeListToArray(_this4.element.querySelectorAll(".is-expanded")).forEach(
              function (item) {
                item.classList.remove("is-expanded");
              },
            );
            Dom.nodeListToArray(
              _this4.element.querySelectorAll('.Header__MainNav [aria-hidden="false"]'),
            ).forEach(function (item) {
              item.setAttribute("aria-hidden", "true");
            });
          });
      ...
      },
      {
        ...
        value: function _openMenu(event, target) {
          ...
          fastdom.mutate(function () {
            ...
            Dom.nodeListToArray(target.children, '.Header__MainNav [aria-hidden="true"]').forEach(
              function (item) {
            ...
            Dom.getSiblings(target, ".is-expanded").forEach(function (item) {
              item.classList.remove("is-expanded");
              Dom.nodeListToArray(item.children, '.Header__MainNav [aria-hidden="false"]').forEach(
                function (item) {
                  item.setAttribute("aria-hidden", "true");
                },
              );
      ...
      },
      {
        ...
        value: function _closeMenu(event, target) {
          ...
          fastdom.mutate(function () {
            ...
            Dom.nodeListToArray(target.children, '.Header__MainNav [aria-hidden="false"]').forEach(
              function (item) {
                item.setAttribute("aria-hidden", "true");
              },
            );
          ...
          fastdom.mutate(function () {
            if (isOverlapping) {
              ...
              if (mainTopMenu) {
                ...
                Array.from(mainTopMenu.querySelectorAll(".HorizontalList__Item")).forEach(
                  function (item) {
            ...
            function (results, status) {
              if (status !== google.maps.GeocoderStatus.OK) {
                ...
                var styledMapType = new google.maps.StyledMapType(
                  JSON.parse(_this2.element.querySelector("[data-gmap-style]").innerHTML),
                );
      ...
      },
      {
        ...
        value: function _loadRecommendations() {
          ...
          var url = ""
            ...
            .concat(this.options["recommendationsCount"], "&intent=related");
      ...
      if (productSlideshowElement) {
        ...
        productSlideshowElement
          ...
          .forEach(function (model) {
            _this.mediaList[model.getAttribute("data-media-id")] = new ProductModel(
              model,
        ...
        productSlideshowElement
          ...
          .forEach(function (video) {
            _this.mediaList[video.getAttribute("data-media-id")] = new ProductVideo(
              video,
              _this.options["stackProductImages"],
      ...
      },
      {
        ...
        value: function _updateSlideshowImage(event) {
          ...
          if (Responsive.matchesBreakpoint("pocket") || !this.options["stackProductImages"]) {
            ...
            document
              .querySelector('[href="#Media'.concat(variant["featured_media"]["id"], '"]'))
      ...
      },
      {
        ...
        value: function _checkQuickNav() {
          ...
          fastdom.measure(function () {
            showAsideQuickNav =
              window.scrollY >=
              _this3.productAsideElement.offsetTop - _this3.productAsideElement.clientHeight;
          });
          fastdom.mutate(function () {
      ...
      },
      {
        ...
        value: function _onImageChanged(event, cell) {
          ...
          if (this.slideshowMobileNav) {
            ...
            Dom.nodeListToArray(this.slideshowMobileNav.querySelectorAll(".dot")).forEach(
              function (item, index) {
            ...
            var calculateMinHeight = function calculateMinHeight() {
              if (_this4.productAsideElement) {
                ...
                _this4.productWrapperElement.style.minHeight = "".concat(
                  _this4.productInfoElement.scrollHeight - parseInt(productInfoStyles.paddingTop),
                  "px",
                );
              }
            };
    ...
    _createClass(ShopTheLookSection, [
      ...
      },
      {
        ...
        value: function _createPocketPopovers() {
          ...
          this.popovers = [];
          Dom.nodeListToArray(this.element.querySelectorAll(".Popover")).forEach(
            function (popover) {
              _this.popovers.push(
                new Popover(popover, {
      ...
      },
      {
        ...
        value: function _createOuterCarousel() {
          ...
          Dom.nodeListToArray(this.element.querySelectorAll(".ShopTheLook__ProductList")).forEach(
            function (item) {
      ...
      },
      {
        ...
        value: function _onProductChanged(selectedIndex, selectedCell) {
          var lookItem = this.outerCarousel.getSelectedCell(),
            activeDot = null;
          Dom.nodeListToArray(lookItem.querySelectorAll(".ShopTheLook__Dot")).forEach(
            function (dot, index) {
          ...
          lookItem
            ...
            .setAttribute("href", selectedCell.getAttribute("data-product-url")); // We trigger an event so that when the dot change we can recalculate the position
          ...
          fastdom.measure(function () {
            ...
            var scale =
                ...
                (selectedCell.offsetWidth -
                  parseInt(window.getComputedStyle(selectedCell).paddingLeft) * 2),
              heightAfterScale = Math.round(selectedCell.offsetHeight * scale),
              // Height of the selected cell once the scale transform is applied
              hiddenImageHeight = Math.round(
                Math.max(
                  heightAfterScale - (window.innerHeight - openPopover.element.offsetHeight),
                  0,
                ),
              ),
            ...
            _this4._calculateTransformForDotListener = function (event) {
              ...
              fastdom.mutate(function () {
                _this4.outerCarousel.flickityInstance.viewport.style.transform = "translate3d(0, "
    ...
    _createClass(SlideshowSection, [
      ...
      },
      {
        ...
        value: function _transitionToSlide(slide) {
          ...
          Dom.nodeListToArray(slide.querySelectorAll(".Slideshow__Image")).forEach(
            function (image) {
              if (
        ...
        value: function connectedCallback() {
          ...
          this.textInputLowerBound.addEventListener("change", function (event) {
            ...
            _this.rangeLowerBound.parentElement.style.setProperty(
              "--range-min",
              "".concat(
                (parseInt(_this.rangeLowerBound.value) / parseInt(_this.rangeLowerBound.max)) * 100,
                "%",
              ),
            );
          });
          this.textInputHigherBound.addEventListener("change", function (event) {
            ...
            _this.rangeHigherBound.parentElement.style.setProperty(
              "--range-max",
              "".concat(
                (parseInt(_this.rangeHigherBound.value) / parseInt(_this.rangeHigherBound.max)) *
                  100,
                "%",
              ),
            );
